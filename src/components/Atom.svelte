...
<head>
    <link rel="stylesheet" href="css/atom_styles.css" />
</head>
    ...
    <div class="atom-body">
        <div class="atom">
            ...
            {#each { length: alumno.td_rank[0] } as _, i}
                ...
                >
                    <div
                        class="electron-background"
                        style="--entityColor: {entityColor};
                            --tim: {orbitTime}s;
                            --initPos: rotateY({-1 *
                            i *
                            (360 / alumno.td_rank[0])}deg); 
                            --endPos: rotateY({-1 * i * (360 / alumno.td_rank[0]) -
                            360}deg);"
                    ></div>
                </div>
            {/each}
